...
class ScientificCalculater(BaseCalculater):
    def __init__(self,parent,theme: Dict[str, str] , history_manager, image_manager):
        ...
        self.height = 550
        self.width = 595
        self.replacement_dict = dict(zip(["÷","^","ᵡ","e","ᴨ","³√(","√("], ["/","**","*","2.718281828459045","3.141592653589793","cur(","sqr("]))
        self._ui_setup()
    ...
    def _ui_setup(self):
        ...
        for buttons in Buttons_config:
            ...
            for button in buttons:
                Button(
                    self.frame,image = self.image_manager.get('standard',button),
